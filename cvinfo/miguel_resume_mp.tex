...
%solutions.
To work in a challenging enviroment, using cutting-edge technology delivering world class software based solutions.
...
Technologies used:
C,XML, Java, IBM  Websphere MQ , AIX,Linux and Murex MX.3.
\end{position}
...
size company) special needs, and then performed a full-scale migration to Linux
