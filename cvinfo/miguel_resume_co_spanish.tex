...
%% Trabajar en un entorno estimulante e implantar  soluciones
%% inform\'{a}ticas de gran calidad.
...
\employer{\textbf{Enero 2008 - Presente}}
\title{\textbf{Analista} }
\location{Accenture} 
...
%Adicinalmente trabaj\'{e} en la instalaci\'{o}n, configuraci\'{o}n y ejecuci\'{o}n  del modelo WaveWatch III de NOAA bajo un cluster basado en Linux con el objetivo de hacer predicciones del oleaje del mar Caribe con alto desempe\~{n}o.\\
%I Worked in the s
