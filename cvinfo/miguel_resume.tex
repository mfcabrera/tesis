...
%solutions.
Work in a challenging enviroment and create world class software based solutions.
...
\title{\textbf{Analyst Jr} }
\location{Accenture} 
\dates{Medell\'{i}n, Colombia }
\begin{position}
Working in the implantation of Murex MX.3 for Bancolombia's treasury
technology rennovation project. As Software developer, mainly with
integration related tasks. Among other activities, customer facing and
requirements analisys and extraction. Technological tools:
Linux,Java,C#, Websphere MQ and Murex MX.3.
